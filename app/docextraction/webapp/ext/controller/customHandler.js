sap.ui.define([
    ...
    "sap/m/BusyDialog"
], function (MessageToast, MessageBox, Spreadsheet, BusyDialog) {
    'use strict';
    ...
    return {
        ...
        handleUploadComplete(oEvent) {
            ...
            if (iStatus === 204) {
                ...
                sMsg = `File Uploaded Successfully. Please wait 60s and then Press *GO* to see the extracted data.`
            ...
            window.setTimeout(() => { obusy.close(); }, 60000);
